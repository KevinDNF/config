...
filetype plugin on 
""enables som file type plugin that idk what even does. default on vim
set path=**
...
"" add this once you get the file and can be edited !!!! nnoremap ,html :-1read $HOME/.vim/.skeleton.html<CR>3jwf>a
