...
hi LineNr		ctermfg=255		ctermbg=none	cterm=none		guifg=#857b6f	guibg=#080808	gui=none
...
hi MatchParen	ctermfg=000		ctermbg=000		cterm=bold		guifg=#ffffff	guibg=#ffffff	gui=bold
